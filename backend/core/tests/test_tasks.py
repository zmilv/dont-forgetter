...
class TestTasks(TestCase):
    ...
    def test_get_new_date_and_time(self):
        result = get_new_date_and_time('2024-01-01', '10:00', '30min', self.current_datetime)
    ...
    def test_reschedule_or_delete_event_without_interval(self):
        ...
        reschedule_or_delete_event(event.pk, self.current_datetime)  # Event should be deleted
    ...
    def test_reschedule_or_delete_event_with_interval(self):
        ...
        reschedule_or_delete_event(event.pk, self.current_datetime)  # Event should be updated
        self.assertEqual(Event.objects.count(), 1)
